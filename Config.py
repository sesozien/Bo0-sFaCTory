...
# رتبتها من الأطول للأقصر عشان الـ Regex يلقط الجمل الذكية المركبة الأول وميخرفش
PRICE_KEYWORDS = [
...
# 🛡️ فلاتر الأمان الافتراضية لمنع التخريف في الأسعار
DEFAULT_MAX_PRICE_LIMIT = 3000
